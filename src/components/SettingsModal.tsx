...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <div className="st-screen">
      ...
      <style>{`
        .st-screen{position:fixed; inset:0; z-index:40; background:var(--st-bg,#F5F3FF); color:var(--st-ink,#1E1B4B); display:flex; flex-direction:column; font-family:'Plus Jakarta Sans',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif; --st-bg:#F5F3FF; --st-surface:#FFFFFF; --st-line:#E4E2F5; --st-line2:#D8D5F0; --st-ink:#1E1B4B; --st-muted:#475569; --st-faint:#6B7280; --st-primary:#6366F1; --st-primary-strong:#4F46E5; --st-primary-soft:#EEF0FE; --st-primary-line:#C7CBFB; --st-cta:#10B981; --st-cta-soft:#ECFDF5; --st-cta-line:#A7F3D0; --st-danger:#DC2626; --st-danger-soft:#FEF2F2;}
